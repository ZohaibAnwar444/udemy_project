...
/**
 * Class m220727_100525_create_table_place_lang
 */
class m220727_100525_create_table_place_lang extends Migration
{
//     /**
//      * {@inheritdoc}
//      */
...
//     {
//         echo "m220727_100525_create_table_place_lang cannot be reverted.\n";
...
//     }
    ...
    public function up()
    {
        ...
        $this->addForeignKey('fk_place_lang_place_id_place','place_lang', 'place_id','place','id', 'restrict');
    }
